...
sbid=1995 #1975 
path=/scratch2/askap/raj030/LMC3/MSDATA_SPLIT/$sbid/ #AVERAGED/
flaggedpath=/scratch2/askap/raj030/LMC3/MSDATA_SPLIT/$sbid/FLAGGED_DYNAMIC/ #FLAGGED_AVERAGED/
...
workdir=/scratch2/askap/raj030/LMC3/WORK/
task=cflag_dynamic
jobname=cflagDyn$sbid
source=1934
for interleave in A #B
do
       ...
       #do
	       ...
	       do
		       iscan=$ibeam 
	               ...
	               msfile=$fieldname\_bm-$ibeam\_scan-$iscan.ms
...
Cflag.selection_flagger.rule1.autocorr  = true 
#Cflag.selection_flagger.rule1.spw   = 0:29
#Cflag.selection_flagger.rule2.antenna   = ak27; ak30
	" >$parset 
